...
import FullRating from "@/app/components/rating/fullRating/page";
import FourRating from "@/app/components/rating/fourRating/page";
                ...
                return(
                    <div key={msg.id} className={`${styles.msg} flex flex-col items-center gap-y-3 bg-bgHover rounded-2xl p-[40px]`}>
                        ...
                        <div className={`${styles.person} flex items-start justify-start gap-x-3 w-[100%]`}>
                            <Image src={msg.img} width='50' height='50' alt={msg.name} loading='lazy' />
